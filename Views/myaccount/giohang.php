...
<div class="container">
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tbody>
            ...
            <?php
                ...
                foreach($products as $row){
                    ...
                    echo        "<div class=\"row\">";
                    echo            "<div class=\"col-sm-3 hidden-xs\"><img src=\"https://localhost/$row->image_thumbnail\" alt=\"$row->name\" class=\"img-responsive\" width=\"100\" /></div>";
        ...
        <tfoot>
            <tr>
                <td>
                    <a href="https://localhost/index.php" class="btn btn-warning">Tiếp tục mua hàng</a>
                </td>
                ...
                <td>
                    <?php
                        if($products != null){
                            echo '<a href="https://localhost/thanhtoan.php" class="btn btn-success btn-block" >Thanh toán</a>';
                        }
                    ?>
