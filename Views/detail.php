                ...
                <div class="preview col-md-6">
                    <div class="preview-pic tab-content">
                        <div class="tab-pane active" id="pic-1">
                            <?php echo "<img src=\"https://localhost/".$images[0]."\"".">"; ?>
                        </div>
                        <div class="tab-pane" id="pic-2">
                        <?php echo "<img src=\"https://localhost/".$images[1]."\"".">"; ?>
                        </div>
                        <div class="tab-pane" id="pic-3">
                        <?php echo "<img src=\"https://localhost/".$images[2]."\"".">"; ?>
                        </div>
                        <div class="tab-pane" id="pic-4">
                        <?php echo "<img src=\"https://localhost/".$images[3]."\"".">"; ?>
                        </div>
                        <div class="tab-pane" id="pic-5">
                        <?php echo "<img src=\"https://localhost/".$images[4]."\"".">"; ?>
                        </div>
                    </div>
                    <ul class="preview-thumbnail nav nav-tabs">
                        <li class="active">
                            <a data-target="#pic-1" data-toggle="tab"><?php echo "<img src=\"https://localhost/".$images[0]."\"".">"; ?></a>
                        </li>
                        <li>
                            <a data-target="#pic-2" data-toggle="tab"><?php echo "<img src=\"https://localhost/".$images[1]."\"".">"; ?></a>
                        </li>
                        <li>
                            <a data-target="#pic-3" data-toggle="tab"><?php echo "<img src=\"https://localhost/".$images[2]."\"".">"; ?></a>
                        </li>
                        <li>
                            <a data-target="#pic-4" data-toggle="tab"><?php echo "<img src=\"https://localhost/".$images[3]."\"".">"; ?></a>
                        </li>
                        <li>
                            <a data-target="#pic-5" data-toggle="tab"><?php echo "<img src=\"https://localhost/".$images[4]."\"".">"; ?></a>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    function add(){
        ...
        if(customer == ""){
            ...
            $.ajax({
                url: 'https://localhost/giohang.php',
                type: 'POST',
                data:{
                    idpro: product,
                    idcus: customer
    ...
    function mua(){
        if(<?php echo $product->amount ?> != 0 ){
            location="https://localhost/thanhtoan.php?id=<?php echo $product->id ?>"
        }
