...
<div class="container">
        <div class="row">
            <div class="col-md-3 offset-4">
                ...
                <br>
                <form method="POST" action="https://localhost/login.php" id="form_dang_nhap">
                    <fieldset>
                ...
                <br> <a href="https://localhost/signup.php">Đăng ký</a>
    ...
    <script type="text/javascript">
        function QuenMatKhau(){
            $("#form_dang_nhap").after("<br><form method=\"POST\" action=\"https://localhost/login.php\"><label >Tên đăng nhập:</label><br><input class=\"form-control\" value=\"\" placeholder=\"Tên đăng nhập...\" name=\"username_forgot\" type=\"text\"><button class=\"btn btn-info\" type=\"submit\" name=\"btn_forgot\" >Reset mật khẩu</button></form>")
        }
    </script>
