...
<br><br>
<center><img src="https://localhost/image/admin_avartar.png" width="200px" height="200px" alt="avatar"></center>
<br><br><br>
<div class="container">
    <div id="alert">
    </div>
...
<script>
    ...
    function check(id) {
        if($('#'+id).val() == "save"){
            $.ajax({
                url: 'https://localhost/manageradmin.php',
                type: 'POST',
                data:{
                    save: 'save',
    ...
    function checkpasswd(id) {
        if($('#'+id).val() == "save"){
            ...
            $('#change_pas').html('<div class="row"><div class="col-3 offset-2"><label for="address"><b>Mật khẩu hiện tại:</b></label></div><div class="col-4"><input class="form-control" id="old_passwd" type="password" ></div></div><br><div class="row"><div class="col-3 offset-2"><label for="phone"><b>Mật khẩu mới:</b></label></div><div class="col-4"><input class="form-control" id="new_passwd" type="password"></div></div><br><div class="row"><div class="col-3 offset-2"><label for="phone"><b>Nhập lại mật khẩu mới:</b></label></div><div class="col-4"><input class="form-control" id="renew_passwd" type="password"></div></div>');
            $('#'+id).val('save');
            $('#'+id).text('Lưu');
            $('#'+id).attr('class', 'btn btn-danger');
        }
