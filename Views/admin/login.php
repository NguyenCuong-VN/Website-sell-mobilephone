    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 offset-4">
                ...
                <br>
                <form method="POST" action="https://localhost/loginadmin.php" id="form_dang_nhap">
                    <fieldset>
    ...
    <script type="text/javascript">
        function QuenMatKhau(){
            $("#form_dang_nhap").after("<br><form method=\"POST\" action=\"https://localhost/loginadmin.php\"><label >Tên đăng nhập:</label><br><input class=\"form-control\" value=\"\" placeholder=\"Tên đăng nhập...\" name=\"username_forgot\" type=\"text\"><button class=\"btn btn-info\" type=\"submit\" name=\"btn_forgot\">Reset mật khẩu</button></form>")
        }
    </script>
