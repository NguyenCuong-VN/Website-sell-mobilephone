...
<body>
    ...
    <!-- load info site -->
    <center>
        <a href="https://localhost/index.php"><img src="https://localhost/image/logo.jpg" class="img.embed-responsive" alt="logo" width="280" height="110"></a>
        <br><br>
    ...
    <!-- load content control button -->
        ...
        <span> | </span>
        <a href="https://localhost/loginadmin.php?logout=true" type="button" class="btn btn-outline-dark" >Đăng xuất</a>
    </center>
